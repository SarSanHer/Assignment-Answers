...
#------------------------ CREATE DBs --------------------
organism1 = ARGV[0] # assign a name to first input file 
organism2 = ARGV[1] # assign a name to second input file 
...
#------------------- WRITE REPORT--------------------
report_file = File.open('./orthologReport2.txt', "a+")
...
report_file.puts "\n\n\t\t\t\t      *** *** ***\n\n"
report_file.puts "The sequences identified as posible orthologues using only BLAST are:"
